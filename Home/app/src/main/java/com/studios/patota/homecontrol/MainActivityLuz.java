...
public class MainActivityLuz extends AppCompatActivity {
    Button btnSalir;
    TextView listex;
    String[] opciones = new String[]{
            "Comedor","Sala","Cocina","Baños","Cuartos","Cochera","Exterior"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout imgf = (LinearLayout) findViewById(R.id.fondoLuz);
        imgf.setBackgroundResource(R.drawable.fondomenu);
        setTitle("SISTEMA ELECTRICO");
       ...
       final   ListView menuCon = (ListView) findViewById(R.id.menuLuz);
